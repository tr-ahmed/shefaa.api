        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultConsultationFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    DefaultAppointmentDurationMinutes = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicStaff_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Investigations = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Notifications_MedicalRecords_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "MedicalRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefillAllowed = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "CreatedAt", "Description", "Name", "NormalizedName", "UserType" },
                values: new object[,]
                {
                    { "role-clinicadmin", null, new DateTime(2026, 6, 30, 8, 6, 23, 654, DateTimeKind.Utc).AddTicks(1998), "Clinic administrator", "ClinicAdmin", "CLINICADMIN", 4 },
                    { "role-clinicstaff", null, new DateTime(2026, 6, 30, 8, 6, 23, 654, DateTimeKind.Utc).AddTicks(1997), "Clinic staff role", "ClinicStaff", "CLINICSTAFF", 3 },
                    { "role-doctor", null, new DateTime(2026, 6, 30, 8, 6, 23, 654, DateTimeKind.Utc).AddTicks(1995), "Doctor role", "Doctor", "DOCTOR", 2 },
                    { "role-patient", null, new DateTime(2026, 6, 30, 8, 6, 23, 654, DateTimeKind.Utc).AddTicks(1608), "Default patient role", "Patient", "PATIENT", 1 },
                    { "role-sysadmin", null, new DateTime(2026, 6, 30, 8, 6, 23, 654, DateTimeKind.Utc).AddTicks(2000), "System administrator", "SystemAdmin", "SYSTEMADMIN", 5 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ConfirmationCode",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentStatusHistories_ChangedAt",
                table: "AppointmentStatusHistories",
                column: "ChangedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicDoctors_ClinicId_DoctorId",
                table: "ClinicDoctors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicStaff_UserId_ClinicId",
                table: "ClinicStaff",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_SpecialtyId_IsActive",
                table: "Doctors",
                columns: new[] { "SpecialtyId", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorSchedules_IsActive",
                table: "DoctorSchedules",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorTimeOffs_DoctorId_StartAt_EndAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_MedicalRecordId",
                table: "Notifications",
                column: "MedicalRecordId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_DoctorId_IsVisible",
                table: "Reviews",
                columns: new[] { "DoctorId", "IsVisible" });
